...
![Condition as received](../assets/photos/01-condition-as-received.jpg)
...
![Original internals](../assets/photos/02-original-internals.jpg)

Original internal layout before replacement of the non-isolated controller.

![Reverse-engineering measurement](../assets/photos/04-reverse-engineering-measurement.jpg)

Tracing and measuring the existing control paths before assigning GPIO roles.

![Indicator board](../assets/photos/05-indicator-board-layout.jpg)
...
![Completed ESP32-S3 controller](../assets/photos/07-esp32s3-controller-complete.jpg)

Completed ESP32-S3 controller before final installation.

![Controller installed](../assets/photos/08-controller-installed.jpg)
...
![Desktop System](../assets/screenshots/desktop-system.png)
